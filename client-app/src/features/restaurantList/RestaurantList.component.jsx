  ...
  renderEmptyState() {
    ...
    return (
      <h2 className="heading-tertiary">
        `Hang tight! We are working on getting you the list of best $
        {this.props.match.params.item} spots in your neighbourhood! `
      </h2>
    );
  }
    ...
    const RestaruantList = this.state.results.map((result) => {
      return (
        <div className="RestaurantInfo" key={result.id}>
          ...
          {/* <img
            src={require("../assets/YelpLogo_Trademark/Screen(R)/Yelp_trademark_RGB.png")}
            alt="yelp"
