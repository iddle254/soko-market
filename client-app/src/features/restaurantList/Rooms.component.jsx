...
function Rooms({ searchItem }) {
  ...
  const fetchMakeup = async () => {
    ...
    const baseURL =
      "https://realtor.p.rapidapi.com/properties/v2/list-for-rent?sort=relevance&city=New%20York%20City&state_code=NY&limit=200&offset=0";
            ...
            >
              ...
              >
                ...
                <div className="result__itemCost" style={{ fontSize: "12px" }}>
                  price: Kshs{result.community.price_max * 100}
                </div>
              </div>
              <div
